...
User clicks "Verify TikTok" button
Bot shows a unique verification code
User adds the code to the beginning of their TikTok bio
User clicks "I Added the Code" and enters their TikTok profile link
Bot checks their bio for the code
If found, user receives the Verified role and is saved to the database
Setup Instructions
1. Discord Developer Portal Setup
Go to Discord Developer Portal
Click "New Application" and give it a name
Go to the Bot section and click "Add Bot"
Copy your Bot Token (you'll need this for .env)
...
Create a new role called "Verified Viewer" (or any name you prefer)
...
Save this Role ID for the .env file
...
User Flow
User clicks the "Verify TikTok" button
Bot shows their unique verification code (e.g., JAIME-12345)
User adds the code to the beginning of their TikTok bio
User clicks "I Added the Code"
User enters their TikTok profile link in the modal
Bot checks their TikTok bio for the code
If found, user receives the Verified role and is saved to the database
Troubleshooting
